...
<!--carousel end-->
		...
		<div class="container">
			...
			$raw_query = "SELECT products.*, images.* FROM products INNER JOIN images ON products.id=images.id where products.hot='$id'";
			...
			foreach ($select as $key => $values) {
				?>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single.php">'<img src="assets/images/productimages/<?php echo $values['imagename'] ?>" class="img-responsive imagessieze" alt="images not found"/></a>
						<div class="mask">
							<a href="single.php?productid= <?php echo $values['product_id'] ?>">Quick View</a>
						</div>
						<a class="product_name" href="single.php"><?php echo $values['name'] ?></a>
						<p><a class="item_add" href="#"><i></i> <span class="item_price"><?php echo $values['pprice'] ?></span></a></p>
					</div>
